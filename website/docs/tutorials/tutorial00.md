...
```scala
val modelFromDataCollection : PointDistributionModel[_3D, TriangleMesh] = PointDistributionModel.createUsingPCA(dc)
...
* Code for this tutorial [code/Tutorial0.scala]